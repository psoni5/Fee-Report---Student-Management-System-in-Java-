	...
	EditStudent(String s)
	{
		...
		b.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				if(status>0)
				{
					JOptionPane.showMessageDialog(EditStudent.this,"record succesfully inserted");
				}
				else
				{
					JOptionPane.showMessageDialog(EditStudent.this,"record not inserted");
					for(int i=0;i<8;i++)
					jt[i].setText("");
				}
				}
